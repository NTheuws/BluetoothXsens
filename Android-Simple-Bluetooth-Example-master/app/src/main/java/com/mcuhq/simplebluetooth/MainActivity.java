...
public class MainActivity extends AppCompatActivity {
    ...
    private static final UUID BT_MODULE_UUID = UUID.fromString("15172002-4947-11E9-8646-D663BD873D93"); // "random" unique identifier
    ...
    // protocol
    private final int SENSOR_ENABLE = 0x01;

    // textview
    private TextView mBluetoothStatus;
    private TextView mReadBuffer;
    private TextView mXaccel;
    private TextView mYaccel;
    private TextView mZaccel;
    private TextView mXangle;
    private TextView mYangle;
    private TextView mZangle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mXaccel = (TextView)findViewById(R.id.x_accel);
        mYaccel = (TextView)findViewById(R.id.y_accel);
        mZaccel = (TextView)findViewById(R.id.z_accel);
        mXangle = (TextView)findViewById(R.id.x_angle);
        mYangle = (TextView)findViewById(R.id.y_angle);
        mZangle = (TextView)findViewById(R.id.z_angle);
